...
const ITEMS: FeatureRowItem[] = [
  ...
  },
  {
    ...
    description: "Set a price, a supply, and a start and end time. Collectors mint directly from a branded drop page on their schedule, not yours to manage manually.",
  },
]
